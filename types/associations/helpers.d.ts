...
export declare function addForeignKeyConstraints(newAttribute: ModelAttributeColumnOptions, source: ModelStatic<Model>, options: AssociationOptions<string>, key: string): void;
/**
...
export declare function getModel<M extends Model>(sequelize: Sequelize, model: string | ModelStatic<M>): ModelStatic<M> | null;
...
export declare type AssociationStatic<T extends Association> = Class<T> & OmitConstructors<typeof Association>;
...
export declare type NormalizeBaseAssociationOptions<T> = Omit<T, 'as' | 'hooks' | 'foreignKey'> & {
    as: string;
    name: {
        singular: string;
        plural: string;
