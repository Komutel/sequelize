...
import type { CreateOptions, CreationAttributes, FindOptions, SaveOptions, ModelStatic, AttributeNames, Attributes } from '../model';
 ...
 */
export declare class HasOne<S extends Model = Model, T extends Model = Model, SourceKey extends AttributeNames<S> = any, TargetKey extends AttributeNames<T> = any, TargetPrimaryKey extends AttributeNames<T> = any> extends Association<S, T, TargetKey, NormalizedHasOneOptions<SourceKey, TargetKey>> {
    #private;
...
export declare type NormalizedHasOneOptions<SourceKey extends string, TargetKey extends string> = NormalizeBaseAssociationOptions<HasOneOptions<SourceKey, TargetKey>>;
/**
 ...
 * @see Model.hasOne
 */
export declare type HasOneGetAssociationMixin<T extends Model> = (options?: HasOneGetAssociationMixinOptions<T>) => Promise<T | null>;
/**
 * The options for the setAssociation mixin of the hasOne association.
 *
 * @see HasOneSetAssociationMixin
 */
export interface HasOneSetAssociationMixinOptions<T extends Model> extends HasOneGetAssociationMixinOptions<T>, SaveOptions<Attributes<T>> {
}
/**
 ...
 * @see Model.hasOne
 */
export declare type HasOneSetAssociationMixin<T extends Model, TModelPrimaryKey> = {
 ...
 * @see Model.hasOne
 */
export declare type HasOneCreateAssociationMixin<T extends Model> = (values?: CreationAttributes<T>, options?: HasOneCreateAssociationMixinOptions<T>) => Promise<T>;
