import type { Model, CreateOptions, CreationAttributes, Filterable, FindOptions, InstanceUpdateOptions, Transactionable, ModelStatic, AttributeNames, Attributes } from '../model';
...
export declare type NormalizedHasManyOptions<SourceKey extends string, TargetKey extends string> = NormalizeBaseAssociationOptions<HasManyOptions<SourceKey, TargetKey>>;
/**
 ...
 * @see Model.hasMany
 */
export declare type HasManyGetAssociationsMixin<T extends Model> = (options?: HasManyGetAssociationsMixinOptions<T>) => Promise<T[]>;
/**
 ...
 * @see Model.hasMany
 */
export declare type HasManySetAssociationsMixin<T extends Model, TModelPrimaryKey> = (newAssociations?: Array<T | TModelPrimaryKey>, options?: HasManySetAssociationsMixinOptions<T>) => Promise<void>;
/**
 ...
 * @see Model.hasMany
 */
export declare type HasManyAddAssociationsMixin<T extends Model, TModelPrimaryKey> = (newAssociations?: Array<T | TModelPrimaryKey>, options?: HasManyAddAssociationsMixinOptions<T>) => Promise<void>;
/**
 ...
 * @see Model.hasMany
 */
export declare type HasManyAddAssociationMixin<T extends Model, TModelPrimaryKey> = (newAssociation?: T | TModelPrimaryKey, options?: HasManyAddAssociationMixinOptions<T>) => Promise<void>;
/**
 ...
 * @see Model.hasMany
 */
export declare type HasManyRemoveAssociationMixin<T extends Model, TModelPrimaryKey> = (oldAssociated?: T | TModelPrimaryKey, options?: HasManyRemoveAssociationMixinOptions<T>) => Promise<void>;
/**
 * The options for the removeAssociations mixin of the hasMany association.
 *
 * @see HasManyRemoveAssociationsMixin
 */
export interface HasManyRemoveAssociationsMixinOptions<T extends Model> extends InstanceUpdateOptions<Attributes<T>> {
}
/**
 ...
 * @see Model.hasMany
 */
export declare type HasManyRemoveAssociationsMixin<T extends Model, TModelPrimaryKey> = (oldAssociateds?: Array<T | TModelPrimaryKey>, options?: HasManyRemoveAssociationsMixinOptions<T>) => Promise<void>;
/**
 ...
 * @see Model.hasMany
 */
export declare type HasManyHasAssociationMixin<TModel extends Model, TModelPrimaryKey> = (target: TModel | TModelPrimaryKey, options?: HasManyHasAssociationMixinOptions<TModel>) => Promise<boolean>;
/**
 ...
 * @see Model.hasMany
 */
export declare type HasManyHasAssociationsMixin<TModel extends Model, TModelPrimaryKey> = (targets: Array<TModel | TModelPrimaryKey>, options?: HasManyHasAssociationsMixinOptions<TModel>) => Promise<boolean>;
/**
 ...
 * @see Model.hasMany
 */
export declare type HasManyCountAssociationsMixin<T extends Model> = (options?: HasManyCountAssociationsMixinOptions<T>) => Promise<number>;
