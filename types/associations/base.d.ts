...
export declare type SingleAssociationAccessors = {
    get: string;
    set: string;
    create: string;
};
export declare type MultiAssociationAccessors = {
    get: string;
    set: string;
    addMultiple: string;
    add: string;
...
export declare type NormalizedAssociationOptions<ForeignKey extends string> = NormalizeBaseAssociationOptions<AssociationOptions<ForeignKey>>;
/**
