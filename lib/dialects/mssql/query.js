...
class MsSqlQuery extends AbstractQuery {
  ...
  handleInsertQuery(results, metaData) {
    if (this.instance) {
      ...
      id = id || (results == null ? void 0 : results.length) && results[0][this.getInsertIdField()];
      id = id || metaData && metaData[this.getInsertIdField()];
      id = id || (results == null ? void 0 : results.length) && results[0][autoIncrementAttribute];
      id = id || autoIncrementAttributeAlias && (results == null ? void 0 : results.length) && results[0][autoIncrementAttributeAlias];
